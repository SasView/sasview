...
class ModelPanel(wx.ScrolledWindow):
    ...
    window_name = "Model Page"
    ## Title to appear on top of the window
    window_caption = "Model page "
    ...
    def old_select_model(self, model):
        """
            Select a new model
            ...
            if event.GetEventObject() == self.disp_cb_dict[p]:              
                if self.disp_cb_dict[p].GetValue() == True:
                    ...
                    if self.values is None or self.weights is None or \
                        ...
                        msg ="The loaded %s distribution is corrupted or empty"%p
                    ...
                    # Store the object to make it persist outside the scope of
                    # this method
    ...
    def _on_select_model(self, event): 
        ...
        evt = ModelEventbox(model=self.model, qmin=qmin, qmax=qmax, qstep=qstep)
