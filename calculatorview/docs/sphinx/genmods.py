...
modules = []
path = os.path.dirname(os.path.join('..', '..', 'calculatorview'))
path = os.path.join(path,'src', 'sans','perspectives', 'calculator')
...
package ='sans.perspectives.calculator'
package_name ='Reference'

if __name__ == "__main__":
    genfiles(package, package_name, modules, dir='../../../sphinx-docs/api/sans/perspectives/calculator')
