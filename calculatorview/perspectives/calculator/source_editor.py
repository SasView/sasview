...
class SourceDialog(wx.Dialog):
    ...
    def _layout_radiation(self):
        ...
        self.radiation_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20), style=0)
    ...
    def _layout_beam_shape(self):
        ...
        self.beam_shape_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20), style=0)  
        self.beam_shape_sizer.AddMany([(beam_shape_txt, 0, wx.LEFT|wx.RIGHT, 10),
    ...
    def _layout_wavelength(self):
        ...
        self.wavelength_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20), style=0)   
        wavelength_unit_txt = wx.StaticText(self, -1, 'Unit: ') 
        self.wavelength_unit_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20),style=0)  
        self.wavelength_sizer.AddMany([(wavelength_txt, 0, wx.LEFT|wx.RIGHT, 10),
    ...
    def _layout_wavelength_min(self):
        ...
        self.wavelength_min_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20), style=0)   
        wavelength_min_unit_txt = wx.StaticText(self, -1, 'Unit: ') 
        self.wavelength_min_unit_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20),style=0)  
        self.wavelength_min_sizer.AddMany([(wavelength_min_txt, 0, wx.LEFT|wx.RIGHT, 10),
    ...
    def _layout_wavelength_max(self):
        ...
        self.wavelength_max_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20), style=0)   
        wavelength_max_unit_txt = wx.StaticText(self, -1, 'Unit: ') 
        self.wavelength_max_unit_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20),style=0)  
        self.wavelength_max_sizer.AddMany([(wavelength_max_txt, 0, wx.LEFT|wx.RIGHT, 10),
    ...
    def _layout_wavelength_spread(self):
        ...
        self.wavelength_spread_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20), style=0)   
        wavelength_spread_unit_txt = wx.StaticText(self, -1, 'Unit: ') 
        self.wavelength_spread_unit_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH, 20),style=0)  
        self.wavelength_spread_sizer.AddMany([(wavelength_spread_txt, 0, wx.LEFT, 10),
    ...
    def _layout_beam_size_name(self):
        ...
        self.beam_size_name_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH*5, 20), style=0) 
        self.beam_size_name_sizer.AddMany([(beam_size_name_txt, 0, wx.LEFT|wx.RIGHT, 10),
    ...
    def _layout_beam_size(self):
        ...
        self.x_beam_size_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH,20), style=0) 
        y_beam_size_txt = wx.StaticText(self, -1, 'y = ')  
        self.y_beam_size_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH,20), style=0) 
        z_beam_size_txt = wx.StaticText(self, -1, 'z = ')  
        self.z_beam_size_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH,20), style=0)  
        beam_size_unit_txt = wx.StaticText(self, -1, 'Unit: ') 
        self.beam_size_unit_tcl = wx.TextCtrl(self, -1, size=(_BOX_WIDTH,20), style=0)  
    ...
    def on_change_wavelength_spread(self):
        ...
        if self._source.wavelength_spread_unit != unit:
            ...
            self._notes += "%s to %s"%(self._source.wavelength_spread_unit, unit)
    ...
    def on_change_beam_size(self):
        ...
        if x_beam_size == "" or x_beam_size == str(None):
            ...
            if check_float(self.x_beam_size_tcl):
                ...
                self._notes += "%s to %s"%(self._source.beam_size.x, x_beam_size)
        #Change y coordinate
        ...
        if y_beam_size == "" or y_beam_size == str(None):
            ...
            if check_float(self.y_beam_size_tcl):
                ...
                self._notes += "%s to %s"%(self._source.beam_size.y, y_beam_size)
        #Change z coordinate
        ...
        if z_beam_size == "" or z_beam_size == str(None):
            ...
            if check_float(self.z_beam_size_tcl):
                ...
                self._notes += "%s to %s"%(self._source.beam_size.z, z_beam_size)
