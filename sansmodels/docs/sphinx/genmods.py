...
modules = []
path = os.path.dirname(os.path.join('..', '..', 'sansmodels'))
path = os.path.join(path,'src', 'sans', 'models')
...
if __name__ == "__main__":
    genfiles(package, package_name, modules, dir='../../../sphinx-docs/api/sans/models')
