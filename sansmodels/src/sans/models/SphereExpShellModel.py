...
import copy
max_nshells = 10
class SphereExpShellModel(BaseComponent):
    """
    This multi-model is based on CoreMultiShellModel with exponential func shells and provides the capability
    of changing the number of shells between 1 and 10.
    """
    def __init__(self, n_shells=1):
        BaseComponent.__init__(self)
        """
        :param n_shells: number of shells in the model, assumes 1<= n_shells <=10.
        """
