...
func_list = {'Erf':0, 'Linear':1, 'RParabolic':2, \
                     'LParabola':3, 'RCubic':4, 'LCubic':5}
max_nshells = 10
class ReflectivityModel(BaseComponent):
    ...
    def __init__(self, multfactor=1):
        ...
        """
        :param multfactor: number of layers in the model, assumes 0<= n_shells <=10.
        """
    ...
    def _clone(self, obj):
        ...
        obj.non_fittable     = copy.deepcopy(self.non_fittable)
    ...
    def getProfile(self):
        ...
        z.append(0)
        beta.append(self.params['sld_sub0']) 
        ...
        beta.append(self.params['sld_medium']) 
        z.insert(0,-z_ext)
        beta.insert(0,self.params['sld_sub0']) 
        z = [z0 - x for x in z]
        z.reverse()
        beta.reverse()  
        return z, beta
