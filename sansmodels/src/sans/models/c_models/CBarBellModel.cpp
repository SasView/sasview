 ...
 *          DO NOT MODIFY THIS FILE, MODIFY barbell.h
...
static PyMemberDef CBarBellModel_members[] = {
    {"params", T_OBJECT, offsetof(CBarBellModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CBarBellModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CBarBellModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
