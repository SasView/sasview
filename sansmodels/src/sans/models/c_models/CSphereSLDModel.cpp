 ...
 *          DO NOT MODIFY THIS FILE, MODIFY spheresld.h
...
static PyMemberDef CSphereSLDModel_members[] = {
    {"params", T_OBJECT, offsetof(CSphereSLDModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CSphereSLDModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CSphereSLDModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
