 ...
 *          DO NOT MODIFY THIS FILE, MODIFY bcc.h
...
static PyMemberDef CBCCrystalModel_members[] = {
    {"params", T_OBJECT, offsetof(CBCCrystalModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CBCCrystalModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CBCCrystalModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
...
void addCBCCrystalModel(PyObject *module) {
    ...
    CBCCrystalModelError = PyErr_NewException("CBCCrystalModel.error", NULL, NULL);
