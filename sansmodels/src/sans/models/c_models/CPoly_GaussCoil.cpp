 ...
 *          DO NOT MODIFY THIS FILE, MODIFY polygausscoil.h
...
static PyMemberDef CPoly_GaussCoil_members[] = {
    {"params", T_OBJECT, offsetof(CPoly_GaussCoil, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CPoly_GaussCoil, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CPoly_GaussCoil, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
