 ...
 *          DO NOT MODIFY THIS FILE, MODIFY fuzzysphere.h
...
static PyMemberDef CFuzzySphereModel_members[] = {
    {"params", T_OBJECT, offsetof(CFuzzySphereModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CFuzzySphereModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CFuzzySphereModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
