 ...
 *          DO NOT MODIFY THIS FILE, MODIFY refl.h
...
CReflModel_init(CReflModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"sld_sub0",Py_BuildValue("d",0.000002070000));
...
static PyMemberDef CReflModel_members[] = {
    {"params", T_OBJECT, offsetof(CReflModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CReflModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CReflModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
...
static PyObject * evalDistribution(CReflModel *self, PyObject *args){
    ...
    self->model->sld_sub0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_sub0") );
