...
static PyMemberDef CCSParallelepipedModel_members[] = {
    {"params", T_OBJECT, offsetof(CCSParallelepipedModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CCSParallelepipedModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CCSParallelepipedModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
