 ...
 *          DO NOT MODIFY THIS FILE, MODIFY capcyl.h
...
static PyMemberDef CCappedCylinderModel_members[] = {
    {"params", T_OBJECT, offsetof(CCappedCylinderModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CCappedCylinderModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CCappedCylinderModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
