 ...
 *          DO NOT MODIFY THIS FILE, MODIFY refl_adv.h
...
static PyMemberDef CReflAdvModel_members[] = {
    {"params", T_OBJECT, offsetof(CReflAdvModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CReflAdvModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CReflAdvModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
