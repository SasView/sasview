 ...
 *          DO NOT MODIFY THIS FILE, MODIFY sld_cal.h
...
static PyMemberDef CSLDCalFunc_members[] = {
    {"params", T_OBJECT, offsetof(CSLDCalFunc, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CSLDCalFunc, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CSLDCalFunc, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
