 ...
 *          DO NOT MODIFY THIS FILE, MODIFY fcc.h
...
static PyMemberDef CFCCrystalModel_members[] = {
    {"params", T_OBJECT, offsetof(CFCCrystalModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CFCCrystalModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CFCCrystalModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
...
void addCFCCrystalModel(PyObject *module) {
    ...
    CFCCrystalModelError = PyErr_NewException("CFCCrystalModel.error", NULL, NULL);
