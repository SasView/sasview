...
CProlateModel_init(CProlateModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"major_core",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"minor_core",Py_BuildValue("d",50.000000000000));
        ...
        PyDict_SetItemString(self->params,"major_shell",Py_BuildValue("d",110.000000000000));
        PyDict_SetItemString(self->params,"contrast",Py_BuildValue("d",0.000001000000));
        PyDict_SetItemString(self->params,"minor_shell",Py_BuildValue("d",60.000000000000));
...
static PyObject *evaluateOneDim(ProlateModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( ProlateModel* model, 
	...
	if (PyArray_Check(x) && PyArray_Check(y)) {
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CProlateModelError, 
                   "CProlateModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CProlateModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CProlateModelError, 
	    	"CProlateModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CProlateModelError, 
                   "CProlateModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CProlateModelError, 
	    		"CProlateModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
 ...
 */
static PyObject * calculate_ER(CProlateModel *self) {
