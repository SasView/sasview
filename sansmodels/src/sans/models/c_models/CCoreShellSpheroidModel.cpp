...
static PyObject * CCoreShellSpheroidModelError = NULL;
...
static void
CCoreShellSpheroidModel_dealloc(CCoreShellSpheroidModel* self)
{
...
static PyObject *
CCoreShellSpheroidModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CCoreShellSpheroidModel *self;
    
    self = (CCoreShellSpheroidModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CCoreShellSpheroidModel_init(CCoreShellSpheroidModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new CoreShellSpheroidModel();
...
static PyMemberDef CCoreShellSpheroidModel_members[] = {
    {"params", T_OBJECT, offsetof(CCoreShellSpheroidModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CCoreShellSpheroidModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CCoreShellSpheroidModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CCoreShellSpheroidModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(CoreShellSpheroidModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( CoreShellSpheroidModel* model, 
                              PyArrayObject *x, PyArrayObject *y)
 {
	...
	if (PyArray_Check(x) && PyArray_Check(y)) {
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CCoreShellSpheroidModelError, 
                   "CCoreShellSpheroidModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CCoreShellSpheroidModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCoreShellSpheroidModelError, 
	    	"CCoreShellSpheroidModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CCoreShellSpheroidModelError, 
                   "CCoreShellSpheroidModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CCoreShellSpheroidModelError, 
	    		"CCoreShellSpheroidModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CCoreShellSpheroidModelError, 
                   "CCoreShellSpheroidModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}else{
	    PyErr_SetString(CCoreShellSpheroidModelError, 
                   "CCoreShellSpheroidModel.evalDistribution couln't be run.");
	    return NULL;
	}
}
 ...
 */
static PyObject * run(CCoreShellSpheroidModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCoreShellSpheroidModelError, 
	    	"CCoreShellSpheroidModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CCoreShellSpheroidModelError, 
	    		"CCoreShellSpheroidModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CCoreShellSpheroidModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CCoreShellSpheroidModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CCoreShellSpheroidModel_readDouble(pars);		
 ...
 * @return: function value
 */
static PyObject * runXY(CCoreShellSpheroidModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CCoreShellSpheroidModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CCoreShellSpheroidModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CCoreShellSpheroidModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CCoreShellSpheroidModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CCoreShellSpheroidModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CCoreShellSpheroidModelError,
	    	"CCoreShellSpheroidModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "equat_core")) {
	    ...
	    PyErr_SetString(CCoreShellSpheroidModelError,
	    	"CCoreShellSpheroidModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CCoreShellSpheroidModel_methods[] = {
...
static PyTypeObject CCoreShellSpheroidModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CCoreShellSpheroidModel",             /*tp_name*/
    sizeof(CCoreShellSpheroidModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CCoreShellSpheroidModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CCoreShellSpheroidModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CCoreShellSpheroidModel_methods,             /* tp_methods */
    CCoreShellSpheroidModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CCoreShellSpheroidModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CCoreShellSpheroidModel_new,                 /* tp_new */
};
...
void addCCoreShellSpheroidModel(PyObject *module) {
    ...
    if (PyType_Ready(&CCoreShellSpheroidModelType) < 0)
        return;

    Py_INCREF(&CCoreShellSpheroidModelType);
    PyModule_AddObject(module, "CCoreShellSpheroidModel", (PyObject *)&CCoreShellSpheroidModelType);
    
    d = PyModule_GetDict(module);
    CCoreShellSpheroidModelError = PyErr_NewException("CCoreShellSpheroidModel.error", NULL, NULL);
    PyDict_SetItemString(d, "CCoreShellSpheroidModelError", CCoreShellSpheroidModelError);
}
