 ...
 *          DO NOT MODIFY THIS FILE, MODIFY lamellarPC.h
...
static PyMemberDef CLamellarPCrystalModel_members[] = {
    {"params", T_OBJECT, offsetof(CLamellarPCrystalModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CLamellarPCrystalModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CLamellarPCrystalModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
