 ...
 *          DO NOT MODIFY THIS FILE, MODIFY fractal.h
...
static PyMemberDef CFractalModel_members[] = {
    {"params", T_OBJECT, offsetof(CFractalModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CFractalModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CFractalModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
