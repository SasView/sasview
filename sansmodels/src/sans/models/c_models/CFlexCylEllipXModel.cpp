 ...
 *          DO NOT MODIFY THIS FILE, MODIFY flexcyl_ellipX.h
...
static PyMemberDef CFlexCylEllipXModel_members[] = {
    {"params", T_OBJECT, offsetof(CFlexCylEllipXModel, params), 0,
     "Parameters"},
	{"dispersion", T_OBJECT, offsetof(CFlexCylEllipXModel, dispersion), 0,
	  "Dispersion parameters"},     
    {"log", T_OBJECT, offsetof(CFlexCylEllipXModel, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
