 ...
 *          DO NOT MODIFY THIS FILE, MODIFY logNormal.h
...
typedef struct {
    ...
    PyObject * log;
    /// Model parameters
	LogNormalParameters model_pars;
} CLogNormal;
...
static PyMemberDef CLogNormal_members[] = {
    {"params", T_OBJECT, offsetof(CLogNormal, params), 0,
     "Parameters"},
    {"log", T_OBJECT, offsetof(CLogNormal, log), 0,
     "Log"},
    {NULL}  /* Sentinel */
};
...
static PyObject * run(CLogNormal *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
		...
		return Py_BuildValue("d",logNormal_analytical_2D(&(self->model_pars),q_value,phi_value));
		...
		return Py_BuildValue("d",logNormal_analytical_1D(&(self->model_pars),q_value));
	}	
}
...
static PyObject * runXY(CLogNormal *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
		...
		return Py_BuildValue("d",logNormal_analytical_2DXY(&(self->model_pars),qx_value,qy_value));
		...
		return Py_BuildValue("d",logNormal_analytical_1D(&(self->model_pars),qx_value));
	}	
}
