...
static PyObject * run(CVesicleModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
		...
		return Py_BuildValue("d",vesicle_analytical_2D(&(self->model_pars),q_value,phi_value));
		...
		return Py_BuildValue("d",vesicle_analytical_1D(&(self->model_pars),q_value));
	}	
}
...
static PyObject * runXY(CVesicleModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
		...
		return Py_BuildValue("d",vesicle_analytical_2DXY(&(self->model_pars),qx_value,qy_value));
		...
		return Py_BuildValue("d",vesicle_analytical_1D(&(self->model_pars),qx_value));
	}	
}
