...
typedef struct {
    ...
    PyObject * log;
    /// Model parameters
	TriaxialEllipsoidParameters model_pars;
} CTriaxialEllipsoidModel;
...
static PyObject * run(CTriaxialEllipsoidModel *self, PyObject *args) {
    ...
    self->model_pars.axis_psi = PyFloat_AsDouble( PyDict_GetItemString(self->params, "axis_psi") );
    self->model_pars.axis_theta = PyFloat_AsDouble( PyDict_GetItemString(self->params, "axis_theta") );
    self->model_pars.semi_axisA = PyFloat_AsDouble( PyDict_GetItemString(self->params, "semi_axisA") );
    self->model_pars.semi_axisB = PyFloat_AsDouble( PyDict_GetItemString(self->params, "semi_axisB") );
    self->model_pars.semi_axisC = PyFloat_AsDouble( PyDict_GetItemString(self->params, "semi_axisC") );
	...
	if( PyList_Check(pars)==1) {
		...
		return Py_BuildValue("d",triaxial_ellipsoid_analytical_2D(&(self->model_pars),q_value,phi_value));
		...
		return Py_BuildValue("d",triaxial_ellipsoid_analytical_1D(&(self->model_pars),q_value));
	}	
}
...
static PyObject * runXY(CTriaxialEllipsoidModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
		...
		return Py_BuildValue("d",triaxial_ellipsoid_analytical_2DXY(&(self->model_pars),qx_value,qy_value));
		...
		return Py_BuildValue("d",triaxial_ellipsoid_analytical_1D(&(self->model_pars),qx_value));
	}	
}
