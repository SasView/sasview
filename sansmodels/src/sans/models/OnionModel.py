...
class OnionModel(COnionModel, BaseComponent):
    ...
    List of default parameters:
         ...
         background      = 0.0 [1/cm]
         sld_out_shell1  = 2e-006 
         sld_out_shell2  = 2.5e-006 
         sld_out_shell3  = 3e-006 
         sld_out_shell4  = 3.5e-006 
         sld_out_shell5  = 4e-006 
         sld_out_shell6  = 4.5e-006 
         sld_out_shell7  = 5e-006 
         sld_out_shell8  = 5.5e-006 
         sld_out_shell9  = 6e-006 
         sld_out_shell10 = 6.2e-006 
         sld_in_shell1   = 1.7e-006 
         sld_in_shell2   = 2.2e-006 
         sld_in_shell3   = 2.7e-006 
         sld_in_shell4   = 3.2e-006 
         sld_in_shell5   = 3.7e-006 
         sld_in_shell6   = 4.2e-006 
         sld_in_shell7   = 4.7e-006 
         sld_in_shell8   = 5.2e-006 
         sld_in_shell9   = 5.7e-006 
         sld_in_shell10  = 6e-006 
         A_shell1        = 1.0 
         A_shell2        = 1.0 
         A_shell3        = 1.0 
         A_shell4        = 1.0 
    ...
    def __init__(self):
        ...
        self.details['sld_out_shell1'] = ['', None, None]
        self.details['sld_out_shell2'] = ['', None, None]
        self.details['sld_out_shell3'] = ['', None, None]
        self.details['sld_out_shell4'] = ['', None, None]
        self.details['sld_out_shell5'] = ['', None, None]
        self.details['sld_out_shell6'] = ['', None, None]
        self.details['sld_out_shell7'] = ['', None, None]
        self.details['sld_out_shell8'] = ['', None, None]
        self.details['sld_out_shell9'] = ['', None, None]
        self.details['sld_out_shell10'] = ['', None, None]
        self.details['sld_in_shell1'] = ['', None, None]
        self.details['sld_in_shell2'] = ['', None, None]
        self.details['sld_in_shell3'] = ['', None, None]
        self.details['sld_in_shell4'] = ['', None, None]
        self.details['sld_in_shell5'] = ['', None, None]
        self.details['sld_in_shell6'] = ['', None, None]
        self.details['sld_in_shell7'] = ['', None, None]
        self.details['sld_in_shell8'] = ['', None, None]
        self.details['sld_in_shell9'] = ['', None, None]
        self.details['sld_in_shell10'] = ['', None, None]
        ...
        self.details['thick_shell1'] = ['', None, None]
        self.details['thick_shell2'] = ['', None, None]
        self.details['thick_shell3'] = ['', None, None]
        self.details['thick_shell4'] = ['', None, None]
        self.details['thick_shell5'] = ['', None, None]
        self.details['thick_shell6'] = ['', None, None]
        self.details['thick_shell7'] = ['', None, None]
        self.details['thick_shell8'] = ['', None, None]
        self.details['thick_shell9'] = ['', None, None]
        self.details['thick_shell10'] = ['', None, None]
