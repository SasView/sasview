...
modules = []
path = os.path.dirname(os.path.join('..', '..', 'sanscalculator'))
path = os.path.join(path, 'src', 'sans', 'calculator')
...
if __name__ == "__main__":
    genfiles(package, package_name, modules, dir='../../../sphinx-docs/api/sans/calculator')
