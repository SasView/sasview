...
version = f"{sasview_version.major}.{sasview_version.minor}"
# The full version, including e.g. alpha tags (a1).
release = sasview_version.public
...
# running Sphinx.
exclude_patterns = [
    "*sas.sasgui.perspectives.simulation.rst",
...
latex_documents = [
    ("index", "SasView.tex", "SasView Documentation", "The SasView Project", "manual"),
]
...
man_pages = [("index", "sasview", "SasView Documentation", ["The SasView Project"], 1)]
...
def autodoc_skip_member_handler(app, what, name, obj, would_skip, options):
    """customise which functions are included in the apidocs

    returns True to indicate that an item should be skipped
    """
    if name.startswith("sas.models"):
        return True
