...
modules = []
path = os.path.dirname(os.path.join('..', '..', 'invariantview'))
path = os.path.join(path, 'src', 'sans','perspectives', 'invariant')
...
package = "sans.perspectives.invariant"
package_name = 'Reference'
#genfiles(package, package_name, modules)

if __name__ == "__main__":
    genfiles(package, package_name, modules, dir='../../../sphinx-docs/api/sans/perspectives/invariant')
