...
if __name__=="__main__":
   ...
   # compute invariant with smear information
    ...
    data = Data1D(x=x,y=y )
    I= InvariantCalculator( data= data)
    print "invariant initialized only with data:", I
    print "invariant q_star",I.q_star
    print "invariant volume",I.volume
    print "Invariant surface",I.surface
    print
    
    print "invariant initialized __call__:", I(contrast=5.3e-6, pConst=20)
    print "invariant q_star",I.q_star
    print "invariant volume",I.volume
    print "Invariant surface",I.surface
    print
    ...
    data= Data1D(x=x,y=y )
    data.dxl =dxl
    I= InvariantCalculator( data= data, contrast=2, pConst=20)
    print "invariant initialize with data, contrast,pConst:", I
    print "invariant q_star",I.q_star
    print "invariant volume",I.volume
    print "Invariant surface",I.surface
    print
    print "invariant error"
    # compute invariant with smear information
