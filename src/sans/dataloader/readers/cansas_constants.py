...
class cansasConstants:
    ...
    SASTRANSSPEC_TDATA_TDEV = {
                               ...
                               "unit" : "transmission_deviation_unit",
                                "attributes" : {
                                                "unit" : {
                                                          "variable" : "{0}.transmission_deviation_unit = \"{1}\"",
                                                          "storeas" : "content"
                                                          }
                                                }
                               }
    ...
    SASINSTR_SRC_WL_SPR = {
                           ...
                           "attributes" : {
                                           "unit" : {
                                                     "variable" : "{0}.source.wavelength_spread_unit = \"{1}\"",  
                                                     "storeas" : "content"
                                                     },
                                           }
                           }
