    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Qminimum', models.FloatField(blank=True, default=None, help_text='Minimum Q value for the fit', null=True)),
                ('Qmaximum', models.FloatField(blank=True, default=None, help_text='Maximum Q value for the fit', null=True)),
