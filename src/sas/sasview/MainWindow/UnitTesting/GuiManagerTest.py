...
from sas.sasview.Utilities.HidableDialog import HidableDialog

from sas.sasview.MainWindow.GuiManager import Acknowledgements, GuiManager
from sas.sasview.MainWindow.MainWindow import MainSasViewWindow
