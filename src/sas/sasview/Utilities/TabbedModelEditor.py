...
from sas.sasview.Utilities.UI.TabbedModelEditor import Ui_TabbedModelEditor
from sas.sasview.Utilities.PluginDefinition import PluginDefinition
...
class TabbedModelEditor(QtWidgets.QDialog, Ui_TabbedModelEditor):
    ...
    def onHelp(self):
        ...
        """
        location = "/user/sasview/Perspectives/Fitting/plugin.html"
