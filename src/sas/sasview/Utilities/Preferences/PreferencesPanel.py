...
from sas.sasview.Utilities.Preferences.UI.PreferencesUI import Ui_preferencesUI
from sas.sasview.Utilities.Preferences.PreferencesWidget import PreferencesWidget
...
class PreferencesPanel(QDialog, Ui_preferencesUI):
    ...
    def help(self):
        ...
        tree_location = "/user/sasview/MainWindow/preferences_help.html"
