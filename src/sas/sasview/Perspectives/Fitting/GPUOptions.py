...
from sas.sasview.Perspectives.Fitting.UI.GPUOptionsUI import Ui_GPUOptions
from sas.sasview.Perspectives.Fitting.UI.GPUTestResultsUI import Ui_GPUTestResults
...
class GPUOptions(QtWidgets.QDialog, Ui_GPUOptions):
    ...
    def helpButtonClicked(self):
        ...
        help_location += "/user/sasview/Perspectives/Fitting/gpu_setup.html"
