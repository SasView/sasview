...
from sas.sasview.Plotting.PlotUtilities import COLORS, COLORS_LETTER, WEIGHTS, FONTS
from sas.sasview.Plotting.UI.PlotLabelPropertiesUI import Ui_PlotLabelPropertiesUI
