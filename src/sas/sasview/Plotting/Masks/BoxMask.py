...
from sas.sasview.Plotting.Slicers.BaseInteractor import BaseInteractor
from sas.sasview.Plotting.Slicers.BoxSum import PointInteractor
from sas.sasview.Plotting.Slicers.BoxSum import VerticalDoubleLine
from sas.sasview.Plotting.Slicers.BoxSum import HorizontalDoubleLine
...
class BoxMask(BaseInteractor):
    ...
    def get_params(self):
        ...
        """
        params = {}
        params["Width"] = np.fabs(self.vertical_lines.half_width) * 2
        params["Height"] = np.fabs(self.horizontal_lines.half_height) * 2
    ...
    def set_params(self, params):
        ...
        """
        x_max = np.fabs(params["Width"]) / 2
        y_max = np.fabs(params["Height"]) / 2
