...
from sas.guiframe.events import EVT_APPEND_BOOKMARK
from sas.guiframe.events import EVT_PANEL_ON_FOCUS
from sas.guiframe.events import EVT_NEW_LOAD_DATA
from sas.guiframe.events import EVT_NEW_COLOR
...
from sas.guiframe.data_panel import DataPanel
from sas.guiframe.panel_base import PanelBase
from sas.guiframe.gui_toolbar import GUIToolBar
...
from sas.guiframe.customdir  import SetupCustom
...
class ViewerFrame(PARENT_FRAME):
    ...
    def __init__(self, parent, title,
        ...
        #data manager
        self.batch_on = False
        from sas.guiframe.data_manager import DataManager
    ...
    def _setup_layout(self):
        ...
        """
        # Status bar
        from sas.guiframe.gui_statusbar import StatusBar
    ...
    def _get_local_plugins(self):
        ...
        if style1 == GUIFRAME.DATALOADER_ON:
            try:
                from sas.guiframe.local_perspectives.data_loader import data_loader
        ...
        if style2 == GUIFRAME.PLOTTING_ON:
            try:
                from sas.guiframe.local_perspectives.plotting import plotting
    ...
    def _on_preference_menu(self, event):
        ...
        """
        from sas.guiframe.startup_configuration \
    ...
    def _onTutorial(self, evt):
        ...
        if config._do_tutorial:
            ...
            if IS_WIN:
                try:
                    from sas.guiframe.pdfview import PDFFrame
    ...
    def _onSphinxDocs(self, evt):
        ...
        DocumentationWindow(self, -1, "index.html", "General Help")
...
class ViewApp(wx.App):
    ...
    def display_splash_screen(self, parent,
        ...
        s_screen = wx.SplashScreen(bitmap=bm,
                                   ...
                                   parent=parent,
                                   id=wx.ID_ANY)
        from sas.guiframe.gui_statusbar import SPageStatusbar
