...
class FittingOptionsTest(unittest.TestCase):
    ...
    def testWidgetFromOptions(self):
        ...
        self.assertIsNone(self.widget.widgetFromOption(QtGui.QMainWindow()))

        # Switch to DREAM
        self.widget.cbAlgorithm.setCurrentIndex(2)
        # test smart call
        self.assertIsInstance(self.widget.widgetFromOption('samples'), QtGui.QLineEdit)
        self.assertIsInstance(self.widget.widgetFromOption('init'), QtGui.QComboBox)
