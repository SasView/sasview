...
# Form implementation generated from reading ui file 'invariant_test.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "I(q) data source", None))
        self.label.setText(_translate("Dialog", "Name:", None))
        self.groupBox_2.setTitle(_translate("Dialog", "Total Q range", None))
        self.label_3.setText(_translate("Dialog", "Min:", None))
        self.label_4.setText(_translate("Dialog", "Max:", None))
        self.label_2.setText(_translate("Dialog", "<html><head/><body><p>Å<span style=\" vertical-align:super;\">-1</span></p></body></html>", None))
        self.groupBox_3.setTitle(_translate("Dialog", "Customized input", None))
        self.label_5.setText(_translate("Dialog", "Background:", None))
        self.label_8.setText(_translate("Dialog", "<html><head/><body><p>cm<span style=\" vertical-align:super;\">-1</span></p></body></html>", None))
        self.label_9.setText(_translate("Dialog", "Scale:", None))
        self.label_6.setText(_translate("Dialog", "Contrast:", None))
        self.label_7.setText(_translate("Dialog", "<html><head/><body><p>Å<span style=\" vertical-align:super;\">-2</span></p></body></html>", None))
        self.label_10.setText(_translate("Dialog", "<html><head/><body><p>Porod<br/>constant:</p></body></html>", None))
        self.label_11.setText(_translate("Dialog", "<html><head/><body><p>(cm Å<span style=\" vertical-align:super;\">4</span>)<span style=\" vertical-align:super;\">-1</span></p></body></html>", None))
        self.groupBox_4.setTitle(_translate("Dialog", "Extrapolation", None))
        self.label_12.setText(_translate("Dialog", "Q Range:", None))
        self.label_14.setText(_translate("Dialog", "Min", None))
        self.label_13.setText(_translate("Dialog", "Max", None))
        self.label_15.setText(_translate("Dialog", "<html><head/><body><p>Å<span style=\" vertical-align:super;\">-1</span></p></body></html>", None))
        self.groupBox_5.setTitle(_translate("Dialog", "Low Q", None))
        self.checkBox.setText(_translate("Dialog", "Enable Low-Q extrapolation", None))
        self.label_16.setText(_translate("Dialog", "Npts:", None))
        self.radioButton.setText(_translate("Dialog", "Guinier", None))
        self.radioButton_3.setText(_translate("Dialog", "Fit", None))
        self.radioButton_2.setText(_translate("Dialog", "Power law", None))
        self.radioButton_4.setText(_translate("Dialog", "Fix", None))
        self.label_17.setText(_translate("Dialog", "Power:", None))
        self.groupBox_6.setTitle(_translate("Dialog", "High Q", None))
        self.checkBox_2.setText(_translate("Dialog", "Enable High-Q extrapolation", None))
        self.label_18.setText(_translate("Dialog", "Npts:", None))
        self.radioButton_7.setText(_translate("Dialog", "Fit", None))
        self.radioButton_8.setText(_translate("Dialog", "Fix", None))
        self.label_19.setText(_translate("Dialog", "Power:", None))
        self.groupBox_7.setTitle(_translate("Dialog", "Output", None))
        self.label_21.setText(_translate("Dialog", "Volume fraction:", None))
        self.label_20.setText(_translate("Dialog", "+/-", None))
        self.label_22.setText(_translate("Dialog", "Specific Surface:", None))
        self.label_23.setText(_translate("Dialog", "+/-", None))
        self.label_24.setText(_translate("Dialog", "<html><head/><body><p>Å<span style=\" vertical-align:super;\">-1</span></p></body></html>", None))
        self.label_25.setText(_translate("Dialog", "Invariant Total [Q]:", None))
        self.label_26.setText(_translate("Dialog", "+/-", None))
        self.label_27.setText(_translate("Dialog", "<html><head/><body><p>(cm Å<span style=\" vertical-align:super;\">3</span>)<span style=\" vertical-align:super;\">-1</span></p></body></html>", None))
        self.pushButton.setText(_translate("Dialog", "Calculate", None))
        self.pushButton_2.setText(_translate("Dialog", "Status", None))
