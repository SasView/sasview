...
class BatchOutputPanelTest:
    ...
    def testActionLoadData(self, widget):
...
"""))
        ...
        widget.setupTableFromCSV = MagicMock()
    ...
    def testActionSendToExcel(self, widget):
        '''Test Excel bindings'''
        pass

    def testActionSaveFile(self, widget):
        '''Test file save'''
        widget.writeBatchToFile = MagicMock()
