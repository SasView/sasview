...
class BatchOutputPanelTest(unittest.TestCase):
    ...
    def testDefaults(self):
        ...
        # Default title
        assert self.widget.windowTitle() == "Batch Fitting Results"
...
"""))
        ...
        with patch('builtins.open', test_csv):
            ...
            assert self.widget.actionLoadData
            self.widget.setupTableFromCSV.assert_called_once()
            assert "File generated by SasView" in self.widget.setupTableFromCSV.call_args[0][0][0]
