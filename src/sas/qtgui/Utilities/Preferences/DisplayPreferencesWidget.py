...
class DisplayPreferencesWidget(PreferencesWidget):
    ...
    def _addAllWidgets(self):
        ...
        self.disableResidualsPlot = self.addCheckBox(
            title="Disable Residuals Display",
            checked=config.DISABLE_RESIDUALS_PLOT)
        self.disableResidualsPlot.clicked.connect(
            lambda: self._stageChange('DISABLE_RESIDUALS_PLOT', self.disableResidualsPlot.isChecked()))
    ...
    def _toggleBlockAllSignaling(self, toggle):
        ...
        self.disableResidualsPlot.blockSignals(toggle)
    ...
    def _restoreFromConfig(self):
        ...
        self.disableResidualsPlot.setChecked(config.DISABLE_RESIDUALS_PLOT)
