...
class PackageGatherer:
    ...
    def get_imported_packages(self):
        ...
        for module_name in sys.modules.keys():
            ...
            if "PySide2" in module_name:
                try:
                    from PySide2.QtCore import PYQT_VERSION_STR
                except Exception as e:
                    # Unable to access PySide2
                    err_version_dict[module_name] = f"Unknown: {e} when attempting to get PySide2 version"
                    pass
                else:
    ...
    def remove_duplicate_modules(self, modules_dict):
        ...
        would be listed in sys.modules. For example the command from PySide2.QtWidgets import QMainWindow,  QMdiArea
        lead to both QMainWindow and QMdiArea being keys, when in reality they are both part of PySide2. This method
