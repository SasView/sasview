...
pyside_Qt_Helpers = glob.glob(
    "SasView*.app/Contents/Resources/PySide6/Qt/lib/Qt*.framework/Helpers/Qt*.app", recursive=True
)
pyside_Qtlibs = glob.glob(
    "SasView*.app/Contents/Resources/PySide6/Qt/lib/Qt*.framework/Versions/A/Qt*", recursive=True
)
pyside_QtApp_Helpers = glob.glob(
    "SasView*.app/Contents/Resources/PySide6/Qt/lib/Qt*.framework/Versions/A/Helpers/Qt*.app", recursive=True
)
...
for sfile in itertools.chain(pyside_QtApp_Helpers):
