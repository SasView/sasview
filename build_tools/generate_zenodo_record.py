...
sasview_data = {
    'metadata': {
    'title': 'SasView version 4.2.1',
    'description': 'TEST',
    'related_identifiers': [{'identifier': 'https://github.com/SasView/sasview/releases/tag/v4.2',
                        'relation': 'isAlternateIdentifier', 'scheme': 'url'}],
    'creators': [
        {'affiliation': 'Oak Ridge National Laboratory', 'name': 'Doucet, Mathieu'},
        {'name': 'Cho, Jae Hie'},
        {'name': 'Alina, Gervaise'},
        ...
        {'name': 'Juhas, Pavol', 'affiliation': 'Brookhaven National Laboratory'},
        ...
        {'name': 'Markvardsen, Anders','affiliation': 'STFC - Rutherford Appleton Laboratory'},
        ...
        {'name': 'Richter, Tobias','affiliation': 'European Spallation Source' },
