...
#export PATH=/Users/wojciechpotrzebowski/anaconda3/bin:$PATH
...
#cd sasview
#cd build_tools
#conda env create --force -f conda_qt5_osx.yml
#conda env list

# Activate new env
conda_env_name="$(grep 'name: ' conda_qt5_osx.yml)"
echo $conda_env_name
...
# List envs
conda list
a='/Users/wojciechpotrzebowski/anaconda3/envs'
b=$conda_env_name
c='/lib'
...
codesign --verify --deep --verbose=4 --force --sign "Developer ID Application: European Spallation Source Eric (W2AG9MPZ43)" SasView5.0.app
