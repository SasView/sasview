...
===========
    - New in Version 4.2.0
      ...
      NOTE: Old-style plugin models, including old sum|multiply models will continue
...
=============================
   ...
   *** Note 1:  If you have a SasView installer (.EXE or .MSI), you do not need to 
   ...
   *** Note 2:  The easiest approach to setting up the proper environment to
   ...
   *** Note 3:  Much more information is available at www.sasview.org under 
