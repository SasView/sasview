...
===========
    - New in Version 4.2.0
      ...
      available for 64bit operating systems. With this version the change to the
      new model API and plugins infrastructure begun with 4.0 is essentially
      complete (though extensions are in the works and more are likely they
      should remain backwardly compatible with previous versions of SasView).
      NOTE: old style plugin models, including old sum|mul mocels will continue
      ...
      - Improvements
         ...
         - Problems with the computation of magnetic scattering from some
           objects have been rectified. Some questions however remain.
      ...
      - Bug Fixes
         ...
         Fixes # 489: ABS reader (NIST 1D) does not handle negative dx properly
           (USANS slit smearing)
         ...
         Fixes # 864: New Model Editor (simple plugin editor) error parsing
           parameter line
         ...
         Fixes # 887: reorganize tree, separating the installed source from the
           build source
         ...
         Fixes # 931: Allow admins to edit all models and upload data etc on
           marketplace
         ...
         Fixes # 954: cross check dll/opencl/python polydispersity and
           orientation results
         ...
         Fixes #1013: FileReaderBaseClass output[] not reset - same file loaded
           multiple times
         Fixes #1018: add Boltzmann distribution
         Fixes #1021: add PDF documentation to website and document in wiki
           release process
         ...
         Fixes #1128: AutoPlot generation for model documentation does not
           include background
...
===============
   ...
   4.2.0 - All systmes
      ...
      posted to Marketplace as available (and fixed in the following release)
