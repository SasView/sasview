...
class cansas_reader_xml(unittest.TestCase):
    ...
    def _checkdata(self):
        ...
        self.assertTrue(self.data.x_unit in self.data.x_converter.scalemap)
        self.assertTrue(self.data.y_unit in self.data.y_converter.scalemap)
        x_in_a = self.data.x_converter(self.data.x, '1/A')
        dx_in_a = self.data.x_converter(self.data.dx, '1/A')
        y_in_cm = self.data.y_converter(self.data.y, '1/cm')
        dy_in_a = self.data.y_converter(self.data.dy, '1/cm')
        self.assertAlmostEqual(x_in_a[0], 0.02, 6)
        self.assertAlmostEqual(y_in_cm[0], 1000, 6)
        self.assertAlmostEqual(dx_in_a[0], 0.01, 6)
        self.assertAlmostEqual(dy_in_a[0], 3, 6)
        self.assertAlmostEqual(x_in_a[1], 0.03, 6)
        self.assertAlmostEqual(y_in_cm[1], 1001.0)
        self.assertAlmostEqual(dx_in_a[1], 0.02, 6)
        self.assertAlmostEqual(dy_in_a[1], 4, 6)
    ...
    def test_slits(self):
        ...
        self.assertAlmostEqual(self.data.x[0], 0.02)
        self.assertAlmostEqual(self.data.y[0], 1000)
        self.assertAlmostEqual(self.data.dxl[0], 0.005)
        self.assertAlmostEqual(self.data.dxw[0], 0.001)
        self.assertAlmostEqual(self.data.dy[0], 3)
        self.assertAlmostEqual(self.data.x[1], 0.03)
        self.assertAlmostEqual(self.data.y[1], 1001.0)
        self.assertAlmostEqual(self.data.dxl[1], 0.005)
        self.assertAlmostEqual(self.data.dxw[1], 0.001)
        self.assertAlmostEqual(self.data.dy[1], 4)
        self.assertEqual(self.data.run_name['1234'], 'run name')
        self.assertEqual(self.data.title, "Test title")
