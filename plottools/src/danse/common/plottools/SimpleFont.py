...
#        self.SetWindowVariant(variant=FONT_VARIANT)
    ...
    def set_default_font(self,font):
        ...
        if not font:
            ...
            self.fontWeight.SetStringSelection(font.get_weight())
            self.fontPoint.SetStringSelection(font.get_size())
            self.fontFamily.SetStringSelection(font.get_family())
            self.fontStyle.SetStringSelection(font.get_style())
        

    def get_font(self):
        FONT = FontProperties()
        font = FONT.copy()
        font.set_size(self.fontPoint.GetValue())
