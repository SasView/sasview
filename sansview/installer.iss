...
[Setup]
AppName=SansView-0.9
AppVerName=SansView 0.9
...
DefaultDirName={pf}\SansView-0.9
DefaultGroupName=DANSE\SansView-0.9
...
Name: "{commondesktop}\SansView 0.9"; Filename: "{app}\SansView.exe"; Tasks: desktopicon; WorkingDir: "{app}"
