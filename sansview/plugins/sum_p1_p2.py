...
from sans.models.SphereModel import SphereModel as P1
from sans.models.CylinderModel import CylinderModel as P2
#from sans.models.SphericalSLDModel import SphericalSLDModel as P1
...
class Model(Model1DPlugin):
    ...
    def __init__(self):
        ...
        """
        ##models 
        #self.p_model1 = self.P_MODEL1(2) # for multifunctional model
        self.p_model1 = self.P_MODEL1()
        self.p_model2 = self.P_MODEL2()

        ## Setting  model name model description
        self.description=""
        self.name = "Sphere(P1)"  +"+"+ "Cylinder(P2)"
        self.description = self.p_model1.name+"\n"
        self.description += self.p_model2.name+"\n"
        self.fill_description(self.p_model1, self.p_model2)
        ...
        self.non_fittable = self.p_model1.non_fittable  
        self.non_fittable += self.p_model2.non_fittable  
        ...
        try:
            multiplicity1 = self.p_model1.multiplicity
            try:
                multiplicity2 = self.p_model2.multiplicity
            except:
                multiplicity2 = 1
        except:
            multiplicity1 = 1
