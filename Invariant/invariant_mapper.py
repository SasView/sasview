...
class InvariantMapper:
    """
    Wrapper for invariant module for map interface
    """
    def __init__(self):
        """
        Initialize the wrapper
        """
    def get_qstar(self, inv, extrapolation=None):
        """
        Get invariant value (Q*)
        """
        return inv.get_qstar(extrapolation)
    
    def get_qstar_with_error(self, inv, extrapolation=None):
        """
        Get invariant value with uncertainty
        """
        return inv.get_qstar_with_error(extrapolation)
    
    def get_volume_fraction(self, inv, contrast, extrapolation=None):
        """
        Get volume fraction
        """
        return inv.get_volume_fraction(contrast, extrapolation)
    
    def get_volume_fraction_with_error(self, inv, contrast, extrapolation=None):
        """
    ...
    def get_surface(self, inv, contrast, porod_const, extrapolation=None):
        """
    ...
    def get_surface_with_error(self, inv, contrast, 
